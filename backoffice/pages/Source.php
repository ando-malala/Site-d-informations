...
<head>
	...
	<meta name="description" content="CRUD des sources du backoffice InfoFlash.">
	<meta name="keywords" content="CRUD, source, backoffice, médias">
	<title>Backoffice Sources | InfoFlash</title>
	...
	<div class="container">
		...
		<div class="collapse navbar-collapse justify-content-center" id="navbarNav">
			<ul class="navbar-nav gap-3">
				...
				<li class="nav-item"><a class="nav-link active" href="source">Sources</a></li>
...
<main class="container pb-5">
	<h2 class="section-title h4">Gestion des sources</h2>
		...
		<div class="card-body">
			<form method="post">
				...
				<div class="mt-3 d-flex gap-2">
					...
					<?php if ($isEdit): ?><a class="btn btn-outline-secondary" href="source">Annuler</a><?php endif; ?>
				</div>
			</form>
		</div>
	</div>
