	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="navbarNav">
			<ul class="navbar-nav me-auto">
				...
				<li class="nav-item"><a class="nav-link active" href="TypeSource.php">TypeSource</a></li>
			</ul>
		...
		<div class="card-body">
			<form method="post">
				...
				<div class="mt-3 d-flex gap-2">
					...
					<?php if ($isEdit): ?><a class="btn btn-secondary" href="TypeSource.php">Annuler</a><?php endif; ?>
				</div>
			</form>
		</div>
	</div>
