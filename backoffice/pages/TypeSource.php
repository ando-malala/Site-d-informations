...
<head>
	...
	<meta name="description" content="CRUD des types de source du backoffice InfoFlash.">
	<meta name="keywords" content="CRUD, type source, backoffice">
	<title>Backoffice Types de source | InfoFlash</title>
	...
	<div class="container">
		...
		<div class="collapse navbar-collapse justify-content-center" id="navbarNav">
			<ul class="navbar-nav gap-3">
				...
				<li class="nav-item"><a class="nav-link active" href="type-source">Types</a></li>
...
<main class="container pb-5">
	<h2 class="section-title h4">Gestion des types de source</h2>
		...
		<div class="card-body">
			<form method="post">
				...
				<div class="mt-3 d-flex gap-2">
					...
					<?php if ($isEdit): ?><a class="btn btn-outline-secondary" href="type-source">Annuler</a><?php endif; ?>
				</div>
			</form>
		</div>
	</div>
