	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="navbarNav">
			<ul class="navbar-nav me-auto">
				...
				<li class="nav-item"><a class="nav-link active" href="CategoryArticle.php">CategoryArticle</a></li>
...
<div class="container py-4">
	<h2 class="mb-4">CRUD CategoryArticle</h2>
		...
		<div class="card-body">
			<form method="post">
				...
				<div class="mt-3 d-flex gap-2">
					...
					<?php if ($isEdit): ?><a class="btn btn-secondary" href="CategoryArticle.php">Annuler</a><?php endif; ?>
				</div>
			</form>
		</div>
	</div>
